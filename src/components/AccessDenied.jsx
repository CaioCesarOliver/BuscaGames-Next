...
export default function AccessDenied() {
  return (
    ...
    <main className="flex justify-center items-center h-screen bg-gray-200 dark:bg-slate-900 px-4">
      <div className="w-[80vw] max-w-3xl h-[80vh] border-4 border-red-600 rounded-lg flex flex-col justify-center items-center p-8 bg-white dark:bg-slate-950">
        <FaLock className="text-red-600 mb-6 text-9xl" />
        <h1 className="text-5xl text-center mb-10 font-bold text-red-600">OPS...</h1>
