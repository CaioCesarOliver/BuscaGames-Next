...
import ContatoForm from '../components/ContatoForm'  // importei aqui
...
export default function Info() {
    ...
    return (
        <>
            ...
            <section
                className="relative w-screen pt-20 min-h-[45vh] bg-cover bg-center flex flex-col justify-center items-center"
                style={{
                    backgroundImage:
            ...
            {/* Conteúdo principal com padding e largura limitada */}
            <main className="bg-gray-100 dark:bg-gray-900 min-h-screen text-white">
...
Cada membro traz sua visão única — seja em desenvolvimento, design ou curadoria de conteúdo — para criar um espaço completo para quem vive e respira jogos. Acreditamos no poder dos games de conectar pessoas, contar histórias e transformar realidades."
                ...
                {/* Team Section com fundo preto full width */}
                <section className="bg-purple-300 dark:bg-gray-950 w-full py-10">
                    <div className="max-w-6xl mx-auto px-5">
                        <p className="text-center text-xl mt-10 text-purple-950 dark:text-white">Quem somos</p>
                        <h1 className="text-6xl text-center mt-1 mb-10 text-purple-950 dark:text-white font-semibold">Equipe do Projeto</h1>
                ...
                {/* Contact Section - movida para depois da equipe */}
                <div className="p-8 md:p-16 max-w-7xl mx-auto ">
                    <section className="w-full bg-gray-100 dark:bg-gray-900 py-10">
                        <div className="max-w-7xl mx-auto px-6">
                            <h1 className='text-6xl text-purple-950 pb-6 font-semibold text-center dark:text-white'>Fale Conosco</h1>
                            <ContatoForm />
                        </div>
                    </section>
                </div>
