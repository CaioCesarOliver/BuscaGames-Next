...
export default function SettingsTabs() {
  ...
  // Função para salvar e exibir SweetAlert
  function handleSave() {
    // Você já está salvando automaticamente no sessionStorage via useEffect,
    // aqui só exibe o alerta.
    Swal.fire({
      icon: "success",
      ...
      background: "#1E293B", // fundo escuro (combina com dark mode)
        ...
        <section className="space-y-6">
          ...
          <div>
            <label className="text-sm font-medium">
              Volume dos Alertas: {alertVolume}%
            </label>
            <input
              type="range"
